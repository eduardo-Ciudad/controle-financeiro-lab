...
class SaldoServiceTest {
    ...
    void saldoCliente_saldoPositivo_situacaoDevedor() {
        ...
        when(lancamentoRepository.calcularSaldo(1L)).thenReturn(new BigDecimal("8000.00"));
    ...
    void dashboard_retornaTotaisCorretos() {
        ...
        when(lancamentoRepository.calcularSaldo(1L)).thenReturn(new BigDecimal("3000.00"));
        when(lancamentoRepository.calcularSaldo(2L)).thenReturn(new BigDecimal("1000.00"));
    ...
    void extrato_calculaSaldoAcumulado() {
        ...
        when(lancamentoRepository.findByClienteIdOrderByDataCompetenciaAscIdAsc(1L, pageable))
